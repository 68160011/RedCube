...
public class CollisionChecker {
    ...
    public void checkTile(Player player) {
        ...
        int playerLeftWorldX = player.worldX;
        int playerRightWorldX = player.worldX + player.solidArea.width;
        int playerTopWorldY = player.worldY;
        int playerBottomWorldY = player.worldY + player.solidArea.height;
